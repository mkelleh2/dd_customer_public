...
variable "escalation_message" {
  description = "This is the message that will be sent to the escalation channel."
  type        = string
  default     = ""
}
...
variable "logs_ingested_bytes" {
  description = "The number of logs ingested bytes to alert on. See plan for details. https://app.datadoghq.com/billing/plan"
  type        = number
  default     = 1000000000
}

variable "apm_ingested_bytes" {
  description = "The number of APM ingested bytes to alert on. See plan for details. https://app.datadoghq.com/billing/plan"
  type        = number
  default     = 1000000000
}

variable "logs_indexed_events" {
  description = "The number of logs indexed events to alert on. See plan for details. https://app.datadoghq.com/billing/plan"
  type        = number
  default     = 1000000
}

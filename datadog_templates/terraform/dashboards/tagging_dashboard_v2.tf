resource "datadog_dashboard" "tagging_v2" {
  description  = "[[suggested_dashboards]]"
  layout_type  = "ordered"
  reflow_type  = "fixed"
  title        = "${var.dashboard_title_prefix} Tagging Review v2"
    ...
    group_definition {
      ...
      widget {
        note_definition {
          ...
          content          = "[metrics without an env tag](https://${var.site}/metric/summary?tags=%21env%3A%2A)  | [logs without an env tag](https://${var.site}/logs?query=-env%3A%2A%20\u0026agg_m=count\u0026agg_m_source=base\u0026agg_q=source\u0026agg_q_source=base\u0026agg_t=count\u0026cols=host%2Cservice\u0026fromUser=true\u0026messageDisplay=inline\u0026refresh_mode=sliding\u0026storage=hot\u0026stream_sort=desc\u0026top_n=10\u0026top_o=top\u0026viz=timeseries\u0026x_missing=true\u0026live=true) | [spans without an env tag](https://${var.site}/apm/traces?query=-env%3A%2A%20\u0026agg_m=count\u0026agg_m_source=base\u0026agg_t=count\u0026cols=core_service%2Ccore_resource_name%2Clog_duration%2Clog_http.method%2Clog_http.status_code\u0026fromUser=false\u0026historicalData=false\u0026messageDisplay=inline\u0026query_translation_version=v0\u0026sort=desc\u0026spanType=all\u0026view=spans\u0026paused=false)"
          font_size        = "14"
          has_padding      = "true"
          show_tick        = "false"
          text_align       = "center"
      ...
      widget {
        query_value_definition {
          ...
          custom_link {
            ...
            link      = "https://${var.site}/orchestration/explorer/pod?query=-env%3A%2A%20\u0026"
          }
  ...
  widget {
    group_definition {
      ...
      widget {
        note_definition {
          background_color = "white"
          content          = "[metrics without a service tag](https://${var.site}/metric/summary?tags=%21service%3A%2A)  | [logs without a service tag](https://${var.site}/logs?query=-service%3A%2A%20\u0026agg_m=count\u0026agg_m_source=base\u0026agg_q=source\u0026agg_q_source=base\u0026agg_t=count\u0026cols=host%2Cservice\u0026fromUser=true\u0026messageDisplay=inline\u0026refresh_mode=sliding\u0026storage=hot\u0026stream_sort=desc\u0026top_n=10\u0026top_o=top\u0026viz=timeseries\u0026x_missing=true\u0026live=true) | [spans without a service tag](https://${var.site}/apm/traces?query=-service%3A%2A%20\u0026agg_m=count\u0026agg_m_source=base\u0026agg_t=count\u0026cols=core_service%2Ccore_resource_name%2Clog_duration%2Clog_http.method%2Clog_http.status_code\u0026fromUser=false\u0026historicalData=false\u0026messageDisplay=inline\u0026query_translation_version=v0\u0026sort=desc\u0026spanType=all\u0026view=spans\u0026paused=false)"
          font_size        = "14"
          has_padding      = "true"
          show_tick        = "false"
          text_align       = "center"
  ...
  widget {
    group_definition {
      ...
      widget {
        note_definition {
          background_color = "white"
          content          = "[metrics without a version tag](https://${var.site}/metric/summary?tags=%21version%3A%2A)  | [logs without a version tag](https://${var.site}/logs?query=-version%3A%2A%20\u0026agg_m=count\u0026agg_m_source=base\u0026agg_q=source\u0026agg_q_source=base\u0026agg_t=count\u0026cols=host%2Cservice\u0026fromUser=true\u0026messageDisplay=inline\u0026refresh_mode=sliding\u0026storage=hot\u0026stream_sort=desc\u0026top_n=10\u0026top_o=top\u0026viz=timeseries\u0026x_missing=true\u0026live=true) | [spans without a version tag](https://${var.site}/apm/traces?query=-version%3A%2A%20\u0026agg_m=count\u0026agg_m_source=base\u0026agg_t=count\u0026cols=core_service%2Ccore_resource_name%2Clog_duration%2Clog_http.method%2Clog_http.status_code\u0026fromUser=false\u0026historicalData=false\u0026messageDisplay=inline\u0026query_translation_version=v0\u0026sort=desc\u0026spanType=all\u0026view=spans\u0026paused=false)"
          font_size        = "14"
          has_padding      = "true"
          show_tick        = "false"
          text_align       = "center"
  ...
  widget {
    group_definition {
      ...
      widget {
        note_definition {
          background_color = "white"
          content          = "[metrics without a product-line tag](https://${var.site}/metric/summary?tags=%21product-line%3A%2A)  | [logs without a product-line tag](https://${var.site}/logs?query=-product-line%3A%2A%20\u0026agg_m=count\u0026agg_m_source=base\u0026agg_q=source\u0026agg_q_source=base\u0026agg_t=count\u0026cols=host%2Cservice\u0026fromUser=true\u0026messageDisplay=inline\u0026refresh_mode=sliding\u0026storage=hot\u0026stream_sort=desc\u0026top_n=10\u0026top_o=top\u0026viz=timeseries\u0026x_missing=true\u0026live=true) | [spans without a product-line tag](https://${var.site}/apm/traces?query=-product-line%3A%2A%20\u0026agg_m=count\u0026agg_m_source=base\u0026agg_t=count\u0026cols=core_service%2Ccore_resource_name%2Clog_duration%2Clog_http.method%2Clog_http.status_code\u0026fromUser=false\u0026historicalData=false\u0026messageDisplay=inline\u0026query_translation_version=v0\u0026sort=desc\u0026spanType=all\u0026view=spans\u0026paused=false)"
          font_size        = "14"
          has_padding      = "true"
          show_tick        = "false"
          text_align       = "center"
  ...
  widget {
    group_definition {
      ...
      widget {
        note_definition {
          background_color = "white"
          content          = "[metrics without a department tag](https://${var.site}/metric/summary?tags=%21department%3A%2A)  | [logs without a department tag](https://${var.site}/logs?query=-department%3A%2A%20\u0026agg_m=count\u0026agg_m_source=base\u0026agg_q=source\u0026agg_q_source=base\u0026agg_t=count\u0026cols=host%2Cservice\u0026fromUser=true\u0026messageDisplay=inline\u0026refresh_mode=sliding\u0026storage=hot\u0026stream_sort=desc\u0026top_n=10\u0026top_o=top\u0026viz=timeseries\u0026x_missing=true\u0026live=true) | [spans without a department tag](https://${var.site}/apm/traces?query=-department%3A%2A%20\u0026agg_m=count\u0026agg_m_source=base\u0026agg_t=count\u0026cols=core_service%2Ccore_resource_name%2Clog_duration%2Clog_http.method%2Clog_http.status_code\u0026fromUser=false\u0026historicalData=false\u0026messageDisplay=inline\u0026query_translation_version=v0\u0026sort=desc\u0026spanType=all\u0026view=spans\u0026paused=false)"
          font_size        = "14"
          has_padding      = "true"
          show_tick        = "false"
          text_align       = "center"
